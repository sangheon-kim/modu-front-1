import { getBucheonSubwayPassengerRequest, getBucheonSubwayPassengerResponse, getBucheonSubwayPassengerResponseData } from "../../@types/PData/buchonSubwayPassenger.type";
import { getCoronaMediaContentChangeRequest } from "../../@types/PData/coronaMediaContentChange.type";
const API_KEY = "hS%2F%2FwEcUnmmYBJuPMtmew3qMA7V7egeudnrhcWcP8BU%2BvzP%2FFhGxwmDEy6l%2BZmcffnLORHXhdpo7hWLNZM108g%3D%3D";
...
export class PDataService {
  ...
  async getBucheonSubwayPassenger(req: getBucheonSubwayPassengerRequest) {
    const { params } = req;
    const url = new URL(`https://api.odcloud.kr/api/3038817/v1/uddi:77d5f727-417a-4f07-a1de-bb342426bb38`);
  ...
  async getCoronaMediaContentChange(req: getCoronaMediaContentChangeRequest) {
    const { params } = req;
    const url = new URL(`https://api.odcloud.kr/api/15077855/v1/uddi:16e53163-2f5b-4a2b-92ae-df884512a310`);
